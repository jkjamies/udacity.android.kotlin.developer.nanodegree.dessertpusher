...
// use the line below to background the app, kill the process, and bring it back and test saved instance state
...
//        Log.i("MainActivity", "onCreate called")
        ...
        // retrieve saved instance state bundle info if exists
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        // note: can do parcelable data/objects as well (limited size, stay far less than 100KB)
