 ...
 *
 */
// add lifecycle param and extend lifecycleobserver to listen to mainactivity lifecycle events
class DessertTimer(lifecycle: Lifecycle): LifecycleObserver {
    ...
    // add init block and set lifecycle observer
    init {
        lifecycle.addObserver(this)
    }

    // add lifecycle event annotation with onstart to trigger function during mainactivity lifecycle event
    ...
    // add lifecycle event annotation with onstop to trigger function during mainactivity lifecycle event
